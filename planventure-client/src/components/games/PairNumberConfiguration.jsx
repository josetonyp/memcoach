import { Box, Typography, Paper, TextField, FormControlLabel, Switch } from '@mui/material';
...
const PairNumberConfiguration = () => {
  ...
  return (
    <Paper id="remember-config" elevation={2} sx={{  p: 3, mt: 2, width: { xs: 300 }, flex: '0 0 300px' }}>
